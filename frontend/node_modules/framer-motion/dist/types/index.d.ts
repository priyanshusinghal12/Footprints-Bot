...
import {
	...
	H as HTMLMotionProps,
	b as HTMLElements,
	G as GenericKeyframesTarget,
	D as DOMMotionComponents,
	c as MotionComponentProps,
	d as HTMLMotionComponents,
	S as SVGMotionComponents,
	E as EventInfo,
	e as FeaturePackages,
	A as AnimationControls,
	V as VisualElement,
	f as AnimationDefinition,
	g as VisualElementAnimationOptions,
	I as IProjectionNode,
	R as ResolvedValues,
	h as HTMLRenderState,
} from "framer-motion/dist/types.d-CtuPurYT";
export {
	U as AnimationLifecycles,
	z as AnimationProps,
	k as AnimationType,
	W as CreateVisualElement,
	l as DragControls,
	w as DragElastic,
	y as DragHandlers,
	x as DraggableProps,
	ah as FeatureDefinition,
	ai as FeatureDefinitions,
	aj as FeaturePackage,
	X as FlatTree,
	n as FocusHandlers,
	N as ForwardRefComponent,
	o as HoverHandlers,
	af as HydratedFeatureDefinition,
	ag as HydratedFeatureDefinitions,
	Y as Inertia,
	Z as Keyframes,
	_ as KeyframesTarget,
	L as LayoutProps,
	ak as LazyFeatureBundle,
	B as MotionAdvancedProps,
	C as MotionStyle,
	...
	al as RenderComponent,
	a1 as Repeat,
	ae as ResolveKeyframes,
	a2 as ResolvedKeyframesTarget,
	a3 as ResolvedSingleTarget,
	a4 as ResolvedValueTarget,
	O as SVGAttributesAsMotionValues,
	Q as SVGMotionProps,
	i as ScrapeMotionValuesFromProps,
	a5 as SingleTarget,
	a6 as Spring,
	v as SwitchLayoutGroupContext,
	T as TapHandlers,
	q as TapInfo,
	a7 as Target,
	a8 as TargetAndTransition,
	a9 as Transition,
	aa as Tween,
	ab as ValueTarget,
	ac as Variant,
	...
	ad as Variants,
	j as VisualState,
	r as createRendererMotionComponent,
	m as makeUseVisualState,
	s as optimizedAppearDataAttribute,
	u as useDragControls,
} from "framer-motion/dist/types.d-CtuPurYT";
...
type ReorderItemProps<V> = Props<V> &
	...
	React$1.PropsWithChildren<{}>;
declare function ReorderItemComponent<V>(
	{ children, style, value, as, onDrag, layout, ...props }: ReorderItemProps<V>,
	externalRef?: React$1.ForwardedRef<any>
): react_jsx_runtime.JSX.Element;
declare const ReorderItem: <V>(
	props: ReorderItemProps<V> & {
		ref?: React$1.ForwardedRef<any>;
	}
...
declare const m: (<Props, TagName extends string = "div">(
	Component: string | TagName | React$1.ComponentType<Props>,
	{
		forwardMotionProps,
	}?: {
		forwardMotionProps: boolean;
	...
	: React$1.ComponentType<
			Omit<MotionComponentProps<Props>, "children"> & {
				children?:
					| ("children" extends keyof Props
							?
									| Props[keyof Props & "children"]
									| MotionComponentProps<Props>[keyof Props & "children"]
							: MotionComponentProps<Props>["children"])
					| undefined;
			}
	  >) &
...
declare const motion: (<Props, TagName extends string = "div">(
	Component: string | TagName | React$1.ComponentType<Props>,
	{
		forwardMotionProps,
	}?: {

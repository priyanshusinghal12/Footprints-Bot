import {
	R as RouteManifest,
	S as ServerRouteModule,
	M as MiddlewareEnabled,
	u as unstable_RouterContextProvider,
	A as AppLoadContext,
	L as LoaderFunctionArgs,
	a as ActionFunctionArgs,
	b as StaticHandlerContext,
	c as RouteModules,
	H as HydrationState,
	D as DataRouteObject,
	C as ClientLoaderFunction,
	d as Router$1,
	e as DataStrategyFunction,
	T as To,
	f as RelativeRoutingType,
	g as Location,
	h as Action,
	P as ParamParseKey,
	i as Path,
	...
	s as NonIndexRouteObject,
	t as LazyRouteFunction,
	v as IndexRouteObject,
	w as Navigator,
	x as RouteMatch,
	y as HTMLFormMethod,
	z as FormEncType,
	E as PageLinkDescriptor,
	G as History,
	J as GetScrollRestorationKeyFunction,
	K as Fetcher,
	O as StaticHandler,
	Q as CreateStaticHandlerOptions$1,
	V as unstable_InitialContext,
	W as LoaderFunction,
	X as ActionFunction,
	Y as MetaFunction,
	Z as LinksFunction,
	...
	$ as Equal,
	a0 as RouterState,
} from "react-router/dist/development/register-DCE0tH5m";
export {
	aA as ClientActionFunction,
	aB as ClientActionFunctionArgs,
	aC as ClientLoaderFunctionArgs,
	ay as DataRouteMatch,
	a7 as DataStrategyFunctionArgs,
	a8 as DataStrategyMatch,
	a9 as DataStrategyResult,
	ab as ErrorResponse,
	ac as FormMethod,
	aJ as Future,
	a1 as GetScrollPositionFunction,
	aD as HeadersArgs,
	aE as HeadersFunction,
	aH as HtmlLinkDescriptor,
	ao as IDLE_BLOCKER,
	an as IDLE_FETCHER,
	am as IDLE_NAVIGATION,
	aI as LinkDescriptor,
	aF as MetaArgs,
	aG as MetaDescriptor,
	a2 as NavigationStates,
	az as PatchRoutesOnNavigationFunctionArgs,
	ae as PathParam,
	af as RedirectFunction,
	aL as Register,
	a6 as RevalidationState,
	a5 as RouterFetchOptions,
	a4 as RouterNavigateOptions,
	a3 as RouterSubscriber,
	ah as ShouldRevalidateFunction,
	ai as ShouldRevalidateFunctionArgs,
	aQ as UNSAFE_DataRouterContext,
	aR as UNSAFE_DataRouterStateContext,
	aa as UNSAFE_DataWithResponseInit,
	aP as UNSAFE_ErrorResponseImpl,
	aS as UNSAFE_FetchersContext,
	aT as UNSAFE_LocationContext,
	aU as UNSAFE_NavigationContext,
	aV as UNSAFE_RouteContext,
	aW as UNSAFE_ViewTransitionContext,
	aM as UNSAFE_createBrowserHistory,
	aO as UNSAFE_createRouter,
	aN as UNSAFE_invariant,
	ak as createPath,
	ap as data,
	aq as generatePath,
	ar as isRouteErrorResponse,
	as as matchPath,
	at as matchRoutes,
	al as parsePath,
	au as redirect,
	av as redirectDocument,
	aw as replace,
	ax as resolvePath,
	ad as unstable_MiddlewareFunction,
	ag as unstable_RouterContext,
	aK as unstable_SerializesTo,
	aj as unstable_createContext,
} from "react-router/dist/development/register-DCE0tH5m";
...
declare function getTurboStreamSingleFetchDataStrategy(
	getRouter: () => Router$1,
	manifest: AssetsManifest,
	routeModules: RouteModules,
	ssr: boolean,
...
declare function decodeViaTurboStream(
...
/**
  ...
  @category Hooks
 */
declare function useRouteLoaderData<T = any>(
	routeId: string
...
declare const FrameworkContext: React.Context<
 ...
 * @category Data Routers
 */
declare function createHashRouter(
	routes: RouteObject[],
	opts?: DOMRouterOpts
): Router$1;
/**
 ...
 * @category Utils
 */
declare function createRoutesStub(
 ...
 */
declare function createMemorySessionStorage<
	Data = SessionData,
	FlashData = Data
>({ cookie }?: MemorySessionStorageOptions): SessionStorage<Data, FlashData>;
...
/**
  ...
  ```
 */
declare function href<Path extends keyof Args>(
	path: Path,
	...args: Args[Path]
): string;

declare function deserializeErrors(
...
declare class RemixErrorBoundary extends React.Component<
...
declare function getPatchRoutesOnNavigationFunction(
	manifest: AssetsManifest,
	routeModules: RouteModules,
	ssr: boolean,
	routeDiscovery: ServerBuild["routeDiscovery"],
...
declare function useFogOFWarDiscovery(
	router: Router$1,
	manifest: AssetsManifest,
	routeModules: RouteModules,
	ssr: boolean,
...
export {
	...
	type Cookie,
	type CookieOptions,
	type CookieSignatureOptions,
	type CreateRequestHandlerFunction,
	type DOMRouterOpts,
	DataRouteObject,
	Router$1 as DataRouter,
	DataStrategyFunction,
	type EntryContext,
	Fetcher,
	...
	To,
	UIMatch,
	type AssetsManifest as UNSAFE_AssetsManifest,
